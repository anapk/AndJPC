...
public class ClassFile
{
    ...
    private static final int MAX_CONSTANT_POOL_SIZE = 64 * 1024;
...
//    }
    ...
    public int addToConstantPool(Object o)
    {
	    ...
	    constantPool[newIndex + 1] = cpInfo;
            ...
            constantPoolObjects.put(o, newIndex);
            return newIndex;
        } else {
            int newIndex = constantPoolCount;
	    constantPool[newIndex] = cpInfo;
    ...
    private ConstantPoolInfo createConstantPoolInfo(Object o)
    {
        if (o instanceof Field) {
            ...
            return new IntegerInfo((Integer) o);
        else if (o instanceof Float)
            return new FloatInfo((Float) o);
        else if (o instanceof Long)
            return new LongInfo((Long) o);
        else if (o instanceof Double)
            return new DoubleInfo((Double) o);
