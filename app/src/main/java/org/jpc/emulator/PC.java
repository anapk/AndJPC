...
public class PC {
    ...
    private static final int DEFAULT_RAM_SIZE = 256 * 1024 * 1024;
    private static final int INSTRUCTIONS_BETWEEN_INTERRUPTS = 1;
     ...
     */
    private PC(Clock clock, DriveSet drives) throws IOException {
     ...
     * @throws java.io.IOException propogated from bios resource loading
     */
    private PC(Clock clock, DriveSet drives, int ramSize) throws IOException {
    ...
    public void loadState(InputStream in) throws IOException {
        ...
        Set<HardwareComponent> newParts = new HashSet<>();
