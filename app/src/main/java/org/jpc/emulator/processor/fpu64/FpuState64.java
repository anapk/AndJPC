...
public class FpuState64 extends FpuState
{
    ...
    private final static int FPU_SPECIAL_TAG_NONE = 0;
    private final static int FPU_SPECIAL_TAG_NAN = 1;
    private final static int FPU_SPECIAL_TAG_UNSUPPORTED = 2;
    private final static int FPU_SPECIAL_TAG_INFINITY = 3;
    private final static int FPU_SPECIAL_TAG_DENORMAL = 4;
    private final static int FPU_SPECIAL_TAG_SNAN = 5;
    ...
    public void saveState(DataOutput output) throws IOException
    {
        ...
        for (double aData : data) output.writeDouble(aData);
        output.writeInt(tag.length);
        for (int aTag : tag) output.writeInt(aTag);
    ...
    private static boolean isDenormal(double x)
    {
