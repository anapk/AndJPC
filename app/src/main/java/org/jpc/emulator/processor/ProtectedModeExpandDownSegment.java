...
private static final Logger LOGGING = Logger.getLogger(ProtectedModeSegment.class.getName());
    ...
    private static final int TYPE_DATA_WRITABLE = 0x2;
    ...
    private static final int DESCRIPTOR_TYPE_CODE_DATA = 0x10;
    ...
    ProtectedModeExpandDownSegment(AddressSpace memory, int selector, long descriptor)
    {
        super(memory);
        this.selector = selector;
        this.descriptor = descriptor;

        boolean granularity = (descriptor & 0x80000000000000L) != 0;
