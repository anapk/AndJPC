...
public class Processor implements HardwareComponent
{
    ...
    private static final int IFLAGS_HARDWARE_INTERRUPT = 0x1;
    public static final int IFLAGS_PROCESSOR_EXCEPTION = 0x2;
    private static final int IFLAGS_RESET_REQUEST = 0x4;
    public static final int IFLAGS_IOPL_MASK = 3 << 12;

    private static final int CR0_PROTECTION_ENABLE = 0x1;
    ...
    private static final int CR0_NUMERIC_ERROR = 0x20;
    private static final int CR0_WRITE_PROTECT = 0x10000;
    private static final int CR0_ALIGNMENT_MASK = 0x40000;
    private static final int CR0_NOT_WRITETHROUGH = 0x20000000;
    private static final int CR0_CACHE_DISABLE = 0x40000000;
    private static final int CR0_PAGING = 0x80000000;

    private static final int CR3_PAGE_CACHE_DISABLE = 0x10;
    private static final int CR3_PAGE_WRITES_TRANSPARENT = 0x8;

    public static final int CR4_VIRTUAL8086_MODE_EXTENSIONS = 0x1;
    private static final int CR4_PROTECTED_MODE_VIRTUAL_INTERRUPTS = 0x2;
    private static final int CR4_TIME_STAMP_DISABLE = 0x4;
    private static final int CR4_DEBUGGING_EXTENSIONS = 0x8;
    private static final int CR4_PAGE_SIZE_EXTENSIONS = 0x10;
    private static final int CR4_PHYSICAL_ADDRESS_EXTENSION = 0x20;
    public static final int CR4_MACHINE_CHECK_ENABLE = 0x40;
    private static final int CR4_PAGE_GLOBAL_ENABLE = 0x80;
    public static final int CR4_PERFORMANCE_MONITORING_COUNTER_ENABLE = 0x100;
    private static final int CR4_OS_SUPPORT_FXSAVE_FXSTORE = 0x200;
    private static final int CR4_OS_SUPPORT_UNMASKED_SIMD_EXCEPTIONS = 0x400;
    ...
    private boolean eflagsCarry; //done
    private boolean eflagsParity; //done
    private boolean eflagsAuxiliaryCarry; //done
    private boolean eflagsZero; //to do
    private boolean eflagsSign; //to do
    public boolean eflagsTrap;
    public boolean eflagsInterruptEnable;
    public boolean eflagsDirection;
    private boolean eflagsOverflow; //done
    ...
    {
	try {
	    return modelSpecificRegisters.get(index);
	} catch (NullPointerException e) {
            LOGGING.log(Level.INFO, "Reading unset MSR {0} : returning 0", index);
	    return 0L;
	}
    }
    ...
    private void handleRealModeInterrupt(int vector)
    {
    ...
    final void handleHardProtectedModeInterrupt(int vector)
    {
	int savedESP = esp;
	int savedEIP = eip;
	Segment savedCS = cs;
    ...
    private void followProtectedModeException(int vector, boolean hasErrorCode, int errorCode, boolean hardware, boolean software)
    {
//        System.out.println();
...
//System.out.println("SS default size flag = " + ss.getDefaultSizeFlag());
    ...
    final void handleHardVirtual8086ModeInterrupt(int vector)
    {
	int savedESP = esp;
	int savedEIP = eip;
	Segment savedCS = cs;
    ...
    private void followVirtual8086ModeException(int vector, boolean hasErrorCode, int errorCode, boolean hardware, boolean software)
    {
        //System.out.println();
