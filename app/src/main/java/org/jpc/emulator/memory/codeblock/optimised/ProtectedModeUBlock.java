...
public class ProtectedModeUBlock implements ProtectedModeCodeBlock
{
    ...
    @Nullable
    private static final OpcodeLogger opcodeCounter = null;//new OpcodeLogger("PM Stats:");

    private ProtectedModeUBlock()
    {
    }
	...
	int position = 0;
		...
		case CMPXCHG_O32_FLAGS: sub_o32_flags(reg2, reg1); break;
...
//                    break;
	...
	} catch (@NonNull IllegalStateException | NullPointerException e) {
    ...
    private void cmpsb_a32(@NonNull Segment seg0)
    {
	int addrOne = cpu.esi;
	int addrTwo = cpu.edi;
    ...
    private void cmpsw_a32(@NonNull Segment seg0)
    {
	int addrOne = cpu.esi;
	int addrTwo = cpu.edi;
    ...
    private void cmpsd_a32(@NonNull Segment seg0)
    {
	int addrOne = cpu.esi;
	int addrTwo = cpu.edi;
    ...
    private void repe_cmpsb_a32(@NonNull Segment seg0)
    {
	int count = cpu.ecx;
	int addrOne = cpu.esi;
	int addrTwo = cpu.edi;
    ...
    private void repe_cmpsw_a32(@NonNull Segment seg0)
    {
	int count = cpu.ecx;
	int addrOne = cpu.esi;
	int addrTwo = cpu.edi;
    ...
    private void repe_cmpsd_a32(@NonNull Segment seg0)
    {
	int count = cpu.ecx;
	int addrOne = cpu.esi;
	int addrTwo = cpu.edi;
    ...
    private void repne_cmpsb_a32(@NonNull Segment seg0)
    {
	int count = cpu.ecx;
	int addrOne = cpu.esi;
	int addrTwo = cpu.edi;
    ...
    private void repne_cmpsw_a32(@NonNull Segment seg0)
    {
	int count = cpu.ecx;
	int addrOne = cpu.esi;
	int addrTwo = cpu.edi;
    ...
    private void repne_cmpsd_a32(@NonNull Segment seg0)
    {
	int count = cpu.ecx;
	int addrOne = cpu.esi;
	int addrTwo = cpu.edi;
    ...
    private void insb_a32(int port)
    {
	if (!checkIOPermissionsByte(port)) {
            LOGGING.log(Level.INFO, "denied access to io port 0x{0} at cpl {1}", new Object[]{Integer.toHexString(port), cpu.getCPL()});
    ...
    private void insw_a32(int port)
    {
    ...
    private void insd_a32(int port)
    {
    ...
    private void rep_insb_a32(int port)
    {
	if (!checkIOPermissionsByte(port)) {
            LOGGING.log(Level.INFO, "denied access to io port 0x{0} at cpl {1}", new Object[]{Integer.toHexString(port), cpu.getCPL()});
	    throw ProcessorException.GENERAL_PROTECTION_0;
    ...
    private void rep_insw_a32(int port)
    {
	if (!checkIOPermissionsShort(port)) {
            LOGGING.log(Level.INFO, "denied access to io port 0x{0} at cpl {1}", new Object[]{Integer.toHexString(port), cpu.getCPL()});
	    throw ProcessorException.GENERAL_PROTECTION_0;
    ...
    private void rep_insd_a32(int port)
    {
	if (!checkIOPermissionsShort(port)) {
            LOGGING.log(Level.INFO, "denied access to io port 0x{0} at cpl {1}", new Object[]{Integer.toHexString(port), cpu.getCPL()});
	    throw ProcessorException.GENERAL_PROTECTION_0;
    ...
    private void outsb_a32(int port, @NonNull Segment storeSegment)
    {
	if (!checkIOPermissionsByte(port)) {
            LOGGING.log(Level.INFO, "denied access to io port 0x{0} at cpl {1}", new Object[]{Integer.toHexString(port), cpu.getCPL()});
	    throw ProcessorException.GENERAL_PROTECTION_0;
    ...
    private void outsw_a32(int port, @NonNull Segment storeSegment)
    {
	if (!checkIOPermissionsShort(port)) {
            LOGGING.log(Level.INFO, "denied access to io port 0x{0} at cpl {1}", new Object[]{Integer.toHexString(port), cpu.getCPL()});
	    throw ProcessorException.GENERAL_PROTECTION_0;
    ...
    private void outsd_a32(int port, @NonNull Segment storeSegment)
    {
	if (!checkIOPermissionsInt(port)) {
            LOGGING.log(Level.INFO, "denied access to io port 0x{0} at cpl {1}", new Object[]{Integer.toHexString(port), cpu.getCPL()});
	    throw ProcessorException.GENERAL_PROTECTION_0;
    ...
    private void rep_outsb_a32(int port, @NonNull Segment storeSegment)
    {
	if (!checkIOPermissionsByte(port)) {
            LOGGING.log(Level.INFO, "denied access to io port 0x{0} at cpl {1}", new Object[]{Integer.toHexString(port), cpu.getCPL()});
	    throw ProcessorException.GENERAL_PROTECTION_0;
    ...
    private void rep_outsw_a32(int port, @NonNull Segment storeSegment)
    {
	if (!checkIOPermissionsShort(port)) {
            LOGGING.log(Level.INFO, "denied access to io port 0x{0} at cpl {1}", new Object[]{Integer.toHexString(port), cpu.getCPL()});
	    throw ProcessorException.GENERAL_PROTECTION_0;
    ...
    private void rep_outsd_a32(int port, @NonNull Segment storeSegment)
    {
	if (!checkIOPermissionsInt(port)) {
            LOGGING.log(Level.INFO, "denied access to io port 0x{0} at cpl {1}", new Object[]{Integer.toHexString(port), cpu.getCPL()});
	    throw ProcessorException.GENERAL_PROTECTION_0;
    ...
    private void scasb_a16(int data)
    {
    ...
    private void scasb_a32(int data)
    {
	int addr = cpu.edi;
	int input = 0xff & cpu.es.getByte(addr);
    ...
    private void scasw_a32(int data)
    {
	int addr = cpu.edi;
    ...
    private void scasd_a32(int data)
    {
	int addr = cpu.edi;
	...
	cpu.edi = addr;
	sub_o32_flags(data, input);
    }

    private void repe_scasb_a16(int data)
    {
        int count = 0xffff & cpu.ecx;
	int addr = 0xffff & cpu.edi;
        boolean used = count != 0;
    ...
    private void repe_scasb_a32(int data)
    {
        int count = cpu.ecx;
	int addr = cpu.edi;
        boolean used = count != 0;
    ...
    private void repe_scasw_a32(int data)
    {
	int count = cpu.ecx;
	int addr = cpu.edi;
        boolean used = count != 0;
    ...
    private void repe_scasd_a32(int data)
    {
	int count = cpu.ecx;
	int addr = cpu.edi;
        boolean used = count != 0;
    ...
    private void repne_scasb_a16(int data)
    {
	int count = 0xFFFF & cpu.ecx;
	int addr = 0xFFFF & cpu.edi;
        boolean used = count != 0;
    ...
    private void repne_scasb_a32(int data)
    {
	int count = cpu.ecx;
	int addr = cpu.edi;
        boolean used = count != 0;
    ...
    private void repne_scasw_a32(int data)
    {
	int count = cpu.ecx;
	int addr = cpu.edi;
        boolean used = count != 0;
    ...
    private void repne_scasd_a16(int data)
    {
	int count = 0xFFFF & cpu.ecx;
	int addr = 0xFFFF & cpu.edi;
        boolean used = count != 0;
    ...
    private void repne_scasd_a32(int data)
    {
	int count = cpu.ecx;
	int addr = cpu.edi;
        boolean used = count != 0;
    ...
    private void stosb_a16(int data)
    {
	int addr = 0xFFFF & cpu.edi;
    ...
    private void stosb_a32(int data)
    {
	int addr = cpu.edi;
	cpu.es.setByte(addr, (byte)data);		
    ...
    private void stosw_a16(int data)
    {
	int addr = 0xFFFF & cpu.edi ;
    ...
    private void stosw_a32(int data)
    {
	int addr = cpu.edi;
	cpu.es.setWord(addr, (short)data);		
    ...
    private void stosd_a16(int data)
    {
	int addr = 0xffff & cpu.edi;
    ...
    private void stosd_a32(int data)
    {
	int addr = cpu.edi;
	cpu.es.setDoubleWord(addr, data);		
    ...
    private void rep_stosb_a16(int data)
    {
	int count = 0xFFFF & cpu.ecx;
	int addr = 0xFFFF & cpu.edi;
	executeCount += count;
    ...
    private void rep_stosb_a32(int data)
    {
	int count = cpu.ecx;
	int addr = cpu.edi;
	executeCount += count;
    ...
    private void rep_stosw_a16(int data)
    {
	int count = 0xFFFF & cpu.ecx;
	int addr = 0xFFFF & cpu.edi;
	executeCount += count;
    ...
    private void rep_stosw_a32(int data)
    {
	int count = cpu.ecx;
	int addr = cpu.edi;
	executeCount += count;
    ...
    private void rep_stosd_a16(int data)
    {
	int count = 0xFFFF & cpu.ecx;
	int addr = 0xFFFF & cpu.edi;
	executeCount += count;
    ...
    private void rep_stosd_a32(int data)
    {
	int count = cpu.ecx;
	int addr = cpu.edi;
	executeCount += count;
    ...
    private void imula_o8(byte data)
    {
    ...
    private void imula_o16(short data)
    {
    ...
    private void imula_o32(int data)
    {
    ...
    private int imul_o16(short data0, short data1)
    {
    ...
    private int imul_o32(int data0, int data1)
    {
	long x = (long)data0;
	long y = (long)data1;
    ...
    private void idiv_o8(byte data)
    {
        if (data == 0)
	    throw ProcessorException.DIVIDE_ERROR;
    ...
    private void idiv_o16(short data)
    {
        if (data == 0) {
	    throw ProcessorException.DIVIDE_ERROR;
        }
    ...
    private void idiv_o32(int data)
    {
	if (data == 0)
	    throw ProcessorException.DIVIDE_ERROR;
    ...
    private int bsf(int source, int initial) throws ProcessorException
    {
	if (source == 0) {
	    cpu.setZeroFlag(true);
	    return initial;
    ...
    private int bsr(int source, int initial) throws ProcessorException
    {
	if (source == 0) {
	    cpu.setZeroFlag(true);
	    return initial;
    ...
    private void aad(int base) throws ProcessorException
    {
        int tl = (cpu.eax & 0xff);
    ...
    private void aam(int base) throws ProcessorException
    {
        int tl = 0xff & cpu.eax;
        if (base == 0) 
            throw ProcessorException.DIVIDE_ERROR;
    ...
    private void jo_o8(byte offset)
    {
	if (cpu.getOverflowFlag()) jump_o8(offset);
    }

    private void jno_o8(byte offset)
    {
	if (!cpu.getOverflowFlag()) jump_o8(offset);
    }

    private void jc_o8(byte offset)
    {
	if (cpu.getCarryFlag()) jump_o8(offset);
    }

    private void jnc_o8(byte offset)
    {
	if (!cpu.getCarryFlag()) jump_o8(offset);
    }

    private void jz_o8(byte offset)
    {
	if (cpu.getZeroFlag()) jump_o8(offset);
    }

    private void jnz_o8(byte offset)
    {
	if (!cpu.getZeroFlag()) jump_o8(offset);
    }

    private void jna_o8(byte offset)
    {
	if (cpu.getCarryFlag() || cpu.getZeroFlag()) jump_o8(offset);
    }

    private void ja_o8(byte offset)
    {
	if ((!cpu.getCarryFlag()) && (!cpu.getZeroFlag())) jump_o8(offset);
    }

    private void js_o8(byte offset)
    {
	if (cpu.getSignFlag()) jump_o8(offset);
    }

    private void jns_o8(byte offset)
    {
	if (!cpu.getSignFlag()) jump_o8(offset);
    }

    private void jp_o8(byte offset)
    {
	if (cpu.getParityFlag()) jump_o8(offset);
    }

    private void jnp_o8(byte offset)
    {
	if (!cpu.getParityFlag()) jump_o8(offset);
    }

    private void jl_o8(byte offset)
    {
	if (cpu.getSignFlag() != cpu.getOverflowFlag()) jump_o8(offset);
    }

    private void jnl_o8(byte offset)
    {
	if (cpu.getSignFlag() == cpu.getOverflowFlag()) jump_o8(offset);
    }

    private void jng_o8(byte offset)
    {
	if (cpu.getZeroFlag() || (cpu.getSignFlag() != cpu.getOverflowFlag())) jump_o8(offset);
    }

    private void jg_o8(byte offset)
    {
	if ((!cpu.getZeroFlag()) && (cpu.getSignFlag() == cpu.getOverflowFlag())) jump_o8(offset);
    }

    private void jo_o16(short offset)
    {
	if (cpu.getOverflowFlag()) jump_o16(offset);
    }

    private void jno_o16(short offset)
    {
	if (!cpu.getOverflowFlag()) jump_o16(offset);
    }

    private void jc_o16(short offset)
    {
	if (cpu.getCarryFlag()) jump_o16(offset);
    }

    private void jnc_o16(short offset)
    {
	if (!cpu.getCarryFlag()) jump_o16(offset);
    }

    private void jz_o16(short offset)
    {
	if (cpu.getZeroFlag()) jump_o16(offset);
    }

    private void jnz_o16(short offset)
    {
	if (!cpu.getZeroFlag()) jump_o16(offset);
    }

    private void jna_o16(short offset)
    {
	if (cpu.getCarryFlag() || cpu.getZeroFlag()) jump_o16(offset);
    }

    private void ja_o16(short offset)
    {
	if ((!cpu.getCarryFlag()) && (!cpu.getZeroFlag())) jump_o16(offset);
    }

    private void js_o16(short offset)
    {
	if (cpu.getSignFlag()) jump_o16(offset);
    }

    private void jns_o16(short offset)
    {
	if (!cpu.getSignFlag()) jump_o16(offset);
    }

    private void jp_o16(short offset)
    {
	if (cpu.getParityFlag()) jump_o16(offset);
    }

    private void jnp_o16(short offset)
    {
	if (!cpu.getParityFlag()) jump_o16(offset);
    }

    private void jl_o16(short offset)
    {
	if (cpu.getSignFlag() != cpu.getOverflowFlag()) jump_o16(offset);
    }

    private void jnl_o16(short offset)
    {
	if (cpu.getSignFlag() == cpu.getOverflowFlag()) jump_o16(offset);
    }

    private void jng_o16(short offset)
    {
	if (cpu.getZeroFlag() || (cpu.getSignFlag() != cpu.getOverflowFlag())) jump_o16(offset);
    }

    private void jg_o16(short offset)
    {
	if ((!cpu.getZeroFlag()) && (cpu.getSignFlag() == cpu.getOverflowFlag())) jump_o16(offset);
    }

    private void jo_o32(int offset)
    {
	if (cpu.getOverflowFlag()) jump_o32(offset);
    }

    private void jno_o32(int offset)
    {
	if (!cpu.getOverflowFlag()) jump_o32(offset);
    }

    private void jc_o32(int offset)
    {
	if (cpu.getCarryFlag()) jump_o32(offset);
    }

    private void jnc_o32(int offset)
    {
	if (!cpu.getCarryFlag()) jump_o32(offset);
    }

    private void jz_o32(int offset)
    {
	if (cpu.getZeroFlag()) jump_o32(offset);
    }

    private void jnz_o32(int offset)
    {
	if (!cpu.getZeroFlag()) jump_o32(offset);
    }

    private void jna_o32(int offset)
    {
	if (cpu.getCarryFlag() || cpu.getZeroFlag()) jump_o32(offset);
    }

    private void ja_o32(int offset)
    {
	if ((!cpu.getCarryFlag()) && (!cpu.getZeroFlag())) jump_o32(offset);
    }

    private void js_o32(int offset)
    {
	if (cpu.getSignFlag()) jump_o32(offset);
    }

    private void jns_o32(int offset)
    {
	if (!cpu.getSignFlag()) jump_o32(offset);
    }

    private void jp_o32(int offset)
    {
	if (cpu.getParityFlag()) jump_o32(offset);
    }

    private void jnp_o32(int offset)
    {
	if (!cpu.getParityFlag()) jump_o32(offset);
    }

    private void jl_o32(int offset)
    {
	if (cpu.getSignFlag() != cpu.getOverflowFlag()) jump_o32(offset);
    }

    private void jnl_o32(int offset)
    {
	if (cpu.getSignFlag() == cpu.getOverflowFlag()) jump_o32(offset);
    }

    private void jng_o32(int offset)
    {
	if (cpu.getZeroFlag() || (cpu.getSignFlag() != cpu.getOverflowFlag())) jump_o32(offset);
    }

    private void jg_o32(int offset)
    {
	if ((!cpu.getZeroFlag()) && (cpu.getSignFlag() == cpu.getOverflowFlag())) jump_o32(offset);
    }
    ...
    private void loop_cx(byte offset)
    {
    ...
    private void loop_ecx(byte offset)
    {
	cpu.ecx--;
	if (cpu.ecx != 0)
	    jump_o8(offset);
    ...
    private void loopz_cx(byte offset)
    {
    ...
    private void loopz_ecx(byte offset)
    {
	cpu.ecx--;
    ...
    private void loopnz_cx(byte offset)
    {
	cpu.ecx= (cpu.ecx & ~0xFFFF) | ((cpu.ecx-1) & 0xFFFF);
	if (!cpu.getZeroFlag() && ((cpu.ecx & 0xFFFF) != 0))
	    jump_o8(offset);
    ...
    private void loopnz_ecx(byte offset)
    {
	cpu.ecx--;
	if (!cpu.getZeroFlag() && (cpu.ecx != 0))
	    jump_o8(offset);
    ...
    private void jump_o8(byte offset)
    {
	if (offset == 0)
    ...
    private void jump_o16(short offset)
    {
    ...
    private void jump_o32(int offset)
    {
	int tempEIP = cpu.eip + offset;
	cpu.cs.checkAddress(tempEIP);// check whether eip is outside cs limit
	cpu.eip = tempEIP;
    ...
    private void jump_abs(int offset)
    {
	cpu.cs.checkAddress(offset);// check whether eip is outside cs limit
	cpu.eip = offset;
    }

    private void jump_far(int targetEIP, int targetSelector)
    {
	...
	default: // not a valid segment descriptor for a jump
            LOGGING.log(Level.WARNING, "Invalid segment type {0,number,integer}", newSegment.getType());
    ...
    private void call_o32_a32(int target)
    {
    ...
    private void call_o16_a16(int target)
    {
    ...
    private void call_o16_a32(int target)
    {
	int tempEIP = 0xFFFF & (cpu.eip + target) ;
    ...
    private void call_o32_a16(int target)
    {
	int tempEIP = cpu.eip + target;
    ...
    private void call_abs_o16_a16(int target)
    {
    ...
    private void call_abs_o16_a32(int target)
    {
	cpu.cs.checkAddress(target & 0xFFFF);
    ...
    private void call_abs_o32_a32(int target)
    {
    ...
    private void call_abs_o32_a16(int target)
    {
	cpu.cs.checkAddress(target);
    ...
    private void call_far_o16_a32(int targetEIP, int targetSelector)
    {
        Segment newSegment = cpu.getSegment(targetSelector);
        if (newSegment == SegmentFactory.NULL_SEGMENT)
            throw new ProcessorException(ProcessorException.Type.GENERAL_PROTECTION, 0, true);//ProcessorException.GENERAL_PROTECTION_0;
...
//                break;
    ...
    private void call_far_o16_a16(int targetEIP, int targetSelector)
    {
...
//                            break;
    ...
    private void call_far_o32_a32(int targetEIP, int targetSelector)
    {
        Segment newSegment = cpu.getSegment(targetSelector);
        if (newSegment == SegmentFactory.NULL_SEGMENT)
            throw new ProcessorException(ProcessorException.Type.GENERAL_PROTECTION, 0, true);//ProcessorException.GENERAL_PROTECTION_0;
...
//                break;
    ...
    private void call_far_o32_a16(int targetEIP, int targetSelector)
    {
        Segment newSegment = cpu.getSegment(targetSelector);
        if (newSegment == SegmentFactory.NULL_SEGMENT)
            throw new ProcessorException(ProcessorException.Type.GENERAL_PROTECTION, 0, true);//ProcessorException.GENERAL_PROTECTION_0;
...
//                break;
    ...
    private void ret_iw_o16_a32(short offset)
    {
	ret_o16_a32();
	cpu.esp += offset;
    }    

    private void ret_iw_o16_a16(short offset)
    {
	ret_o16_a16();
    ...
    private void ret_iw_o32_a32(short offset)
    {
	ret_o32_a32();
	cpu.esp += offset;
    }    

    private void ret_iw_o32_a16(short offset)
    {
	ret_o32_a16();
	cpu.esp = (cpu.esp & ~0xffff) | (((cpu.esp & 0xFFFF) + offset) & 0xffff);
    }

    private void ret_far_o16_a16(int stackdelta)
    {
	try {
    ...
    private void ret_far_o16_a32(int stackdelta)
    {
	try {
    ...
    private void ret_far_o32_a16(int stackdelta)
    {
	try {
    ...
    private void ret_far_o32_a32(int stackdelta)
    {
	try {
    ...
    private int iretToVirtual8086Mode16BitAddressing(int newCS, int newEIP, int newEFlags)
    {
	try {
    ...
    private int iret32ProtectedMode16BitAddressing(int newCS, int newEIP, int newEFlags)
    {
	...
	switch (returnSegment.getType()) {
	default:
            LOGGING.log(Level.WARNING, "Invalid segment type {0,number,integer}", returnSegment.getType());
...
// 		    cpu.esp = (cpu.esp & ~0xFFFF) | ((cpu.esp+12)&0xFFFF);
    ...
    private int iretFromTask()
    {
	throw new IllegalStateException("Execute Failed");
    }

    private int iretToVirtual8086Mode32BitAddressing(int newCS, int newEIP, int newEFlags)
    {
	try {
    ...
    private int iret32ProtectedMode32BitAddressing(int newCS, int newEIP, int newEFlags)
    {
	Segment returnSegment = cpu.getSegment(newCS);
    ...
    private int iret16ProtectedMode16BitAddressing(int newCS, int newEIP, int newEFlags)
    {
	Segment returnSegment = cpu.getSegment(newCS);
    ...
    private int iret16ProtectedMode32BitAddressing(int newCS, int newEIP, int newEFlags)
    {
	Segment returnSegment = cpu.getSegment(newCS);
    ...
    private void sysexit(int esp, int eip)
    {
	int csSelector= (int)cpu.getMSR(Processor.SYSENTER_CS_MSR);
	if (csSelector == 0)
	    throw ProcessorException.GENERAL_PROTECTION_0;
    ...
    private void out_o8(int port, int data)
    {
	if (checkIOPermissionsByte(port))
    ...
    private void out_o16(int port, int data)
    {
	if (checkIOPermissionsShort(port))
    ...
    private void out_o32(int port, int data)
    {
	if (checkIOPermissionsInt(port))
    ...
    private void enter_o16_a16(int frameSize, int nestingLevel)
    {
        nestingLevel %= 32;
    ...
    private void enter_o16_a32(int frameSize, int nestingLevel)
    {
        nestingLevel %= 32;
    ...
    private void enter_o32_a32(int frameSize, int nestingLevel)
    {
	nestingLevel %= 32;
    ...
    private void push_o32_a32(int value)
    {
	if ((cpu.esp < 4) && (cpu.esp > 0))
	    throw ProcessorException.STACK_SEGMENT_0;
    ...
    private void push_o32_a16(int value)
    {
    ...
    private void push_o16_a32(short value)
    {
	if ((cpu.esp < 2) && (cpu.esp > 0))
	    throw ProcessorException.STACK_SEGMENT_0;
    ...
    private void push_o16_a16(short value)
    {
    ...
    private int lar(int selector, int original)
    {
        if ((selector & 0xFFC) == 0)
        {
            cpu.setZeroFlag(false);
    ...
    private int lsl(int selector, int original)
    {
        int offset = selector & 0xfff8;
    ...
    private Segment lldt(int selector)
    {
	selector &= 0xffff;
    ...
    private Segment ltr(int selector)
    {
    ...
    private void bitwise_flags(short result)
    {
        cpu.setOverflowFlag(false);
        cpu.setCarryFlag(false);
        cpu.setZeroFlag(result);
    ...
    private void arithmetic_flags_o8(int result, int operand1, int operand2)
    {
    ...
    private void arithmetic_flags_o16(int result, int operand1, int operand2)
    {
    ...
    private void arithmetic_flags_o32(long result, int operand1, int operand2)
    {
    ...
    private void add_o32_flags(int operand1, int operand2)
    {
    ...
    private void adc_o16_flags(int result, int operand1, int operand2)
    {
    ...
    private void adc_o8_flags(int result, int operand1, int operand2)
    {
    ...
    private void sub_o32_flags(int operand1, int operand2)
    {
        long result = (0xffffffffl & operand1) - (0xffffffffl & operand2);
    ...
    private void sub_o16_flags(int result, int operand1, int operand2)
    {
	arithmetic_flags_o16(result, operand1, operand2);
	cpu.setOverflowFlag(result, operand1, operand2, Processor.OF_SUB_SHORT);
    }

    private void sub_o8_flags(int result, int operand1, int operand2)
    {
	arithmetic_flags_o8(result, operand1, operand2);
	cpu.setOverflowFlag(result, operand1, operand2, Processor.OF_SUB_BYTE);
    }

    private void sbb_o32_flags(int operand1, int operand2)
    {
	int carry = (cpu.getCarryFlag() ? 1 : 0);
        long result = (0xffffffffl & operand1) - ((0xffffffffl & operand2) + carry);
    ...
    private void sbb_o16_flags(int result, int operand1, int operand2)
    {
	cpu.setOverflowFlag(result, operand1, operand2, Processor.OF_SUB_SHORT);
	arithmetic_flags_o16(result, operand1, operand2);
    }

    private void sbb_o8_flags(int result, int operand1, int operand2)
    {
	cpu.setOverflowFlag(result, operand1, operand2, Processor.OF_SUB_BYTE);
	arithmetic_flags_o8(result, operand1, operand2);
    }

    private void dec_flags(int result)
    {
        cpu.setZeroFlag(result);
        cpu.setParityFlag(result);
	cpu.setSignFlag(result);
    ...
    private void dec_flags(short result)
    {
        cpu.setZeroFlag(result);
        cpu.setParityFlag(result);
	cpu.setSignFlag(result);
    ...
    private void dec_flags(byte result)
    {
        cpu.setZeroFlag(result);
        cpu.setParityFlag(result);
	cpu.setSignFlag(result);
    ...
    private void inc_flags(int result)
    {
        cpu.setZeroFlag(result);
        cpu.setParityFlag(result);
	cpu.setSignFlag(result);
    ...
    private void inc_flags(short result)
    {
        cpu.setZeroFlag(result);
        cpu.setParityFlag(result);
	cpu.setSignFlag(result);
    ...
    private void inc_flags(byte result)
    {
        cpu.setZeroFlag(result);
        cpu.setParityFlag(result);
	cpu.setSignFlag(result);
    ...
    private void shl_flags(byte result, byte initial, int count)
    {
        if (count > 0) {
    ...
    private void shl_flags(short result, short initial, int count)
    {
        if (count > 0) {	    
    ...
    private void shl_flags(int result, int initial, int count)
    {
        if (count > 0) {	    
    ...
    private void shr_flags(byte result, int initial, int count)
    {
        if (count > 0) {
    ...
    private void shr_flags(short result, int initial, int count)
    {
        if (count > 0) {	    
	    cpu.setCarryFlag(initial, count, Processor.CY_SHR_OUTBIT);
    ...
    private void shr_flags(int result, int initial, int count)
    {
        if (count > 0) {	    
	    cpu.setCarryFlag(initial, count, Processor.CY_SHR_OUTBIT);
    ...
    private void sar_flags(byte result, byte initial, int count)
    {
        if (count > 0) {
	    cpu.setCarryFlag(initial, count, Processor.CY_SHR_OUTBIT);
    ...
    private void sar_flags(short result, short initial, int count)
    {
        if (count > 0) {
	    cpu.setCarryFlag(initial, count, Processor.CY_SHR_OUTBIT);
            if (count == 1) cpu.setOverflowFlag(false);
    ...
    private void rol_flags(byte result, int count)
    {
	if (count > 0) {
    ...
    private void rol_flags(short result, int count)
    {
	if (count > 0) {
	    cpu.setCarryFlag(result, Processor.CY_LOWBIT);
	    if (count == 1)
    ...
    private void rol_flags(int result, int count)
    {
	if (count > 0) {
	    cpu.setCarryFlag(result, Processor.CY_LOWBIT);
	    if (count == 1)
    ...
    private void ror_flags(byte result, int count)
    {
	if (count > 0) {
    ...
    private void ror_flags(short result, int count)
    {
	if (count > 0) {
    ...
    private void ror_flags(int result, int count)
    {
	if (count > 0) {
    ...
    private void rcl_o8_flags(int result, int count)
    {
	if (count > 0) {
    ...
    private void rcl_o16_flags(int result, int count)
    {
	if (count > 0) {
    ...
    private void rcl_o32_flags(long result, int count)
    {
	if (count > 0) {
    ...
    private void rcr_o8_flags(int result, int count, int overflow)
    {
	if (count > 0) {
	    cpu.setCarryFlag(result, Processor.CY_OFFENDBIT_BYTE);
            if (count == 1)
    ...
    private void rcr_o16_flags(int result, int count, int overflow)
    {
	if (count > 0) {
	    cpu.setCarryFlag(result, Processor.CY_OFFENDBIT_SHORT);
            if (count == 1)
    ...
    private void rcr_o32_flags(long result, int count, int overflow)
    {
	if (count > 0) {
	    cpu.setCarryFlag(result, Processor.CY_OFFENDBIT_INT);
            if (count == 1)
    ...
    private void neg_flags(byte result)
    {
	cpu.setCarryFlag(result, Processor.CY_NZ);
	cpu.setOverflowFlag(result, Processor.OF_MIN_BYTE);
    ...
    private void neg_flags(short result)
    {
	cpu.setCarryFlag(result, Processor.CY_NZ);
	cpu.setOverflowFlag(result, Processor.OF_MIN_SHORT);
    ...
    private void neg_flags(int result)
    {
	cpu.setCarryFlag(result, Processor.CY_NZ);
	cpu.setOverflowFlag(result, Processor.OF_MIN_INT);
    ...
    private Segment loadSegment(int selector)
    {
	selector &= 0xffff;
	if (selector < 0x4)
	    return SegmentFactory.NULL_SEGMENT;
    ...
    private boolean checkIOPermissionsByte(int ioportAddress)
    {
	if (cpu.getCPL() <= cpu.eflagsIOPrivilegeLevel)
	    return true;
    ...
    private boolean checkIOPermissionsShort(int ioportAddress)
    {
	if (cpu.getCPL() <= cpu.eflagsIOPrivilegeLevel)
	    return true;
    ...
    private boolean checkIOPermissionsInt(int ioportAddress)
    {
	if (cpu.getCPL() <= cpu.eflagsIOPrivilegeLevel)
	    return true;
