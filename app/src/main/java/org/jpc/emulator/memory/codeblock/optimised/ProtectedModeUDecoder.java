...
{ 
	...
	case 4:
	    ...
	    break;
	default:
            LOGGING.log(Level.SEVERE, "{0} byte displacement invalid", operationHasDisplacement(prefices, opcode, modrm, sib));
	    break;
	}
	...
	case 6:
	    ...
	    break;
	default:
            LOGGING.log(Level.SEVERE, "{0} byte immediate invalid", operationHasImmediate(prefices, opcode, modrm));
	    break;
	}
...
//            break;
    ...
    private static boolean isFarJump(int opcode, int modrm)
    {
        switch (opcode) 
        {
	case 0x9a: //CALLF Ap
    ...
    private static boolean isNearJump(int opcode, int modrm)
    {
        switch (opcode) 
        {
	case 0x70: //Jcc Jb
    ...
    private static boolean isModeSwitch(int opcode, int modrm)
    {
	switch (opcode) {
    ...
    private static boolean isBlockTerminating(int opcode, int modrm)
    {
	switch (opcode) {
	//case 0xfb: //STI
	case 0xf4: //HLT
    ...
    private static boolean isJump(int opcode, int modrm)
    {
