...
public abstract class AbstractMemory implements Memory
{
     ...
     */
    final short getWordInBytes(int offset)
    {
     ...
     */
    final int getDoubleWordInBytes(int offset)
    {
     ...
     */
    final long getQuadWordInBytes(int offset)
    {
     ...
     */
    final void setWordInBytes(int offset, short data)
    {
     ...
     */
    final void setDoubleWordInBytes(int offset, int data)
    {
        setByte(offset, (byte) data);
	offset++;
        data >>= 8;
     ...
     */
    final void setQuadWordInBytes(int offset, long data)
    {
