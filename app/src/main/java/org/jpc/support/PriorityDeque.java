 ...
 */
class PriorityDeque<E> extends AbstractQueue<E> implements Deque<E>
{
     ...
     */
    private PriorityDeque(int initialCapacity)
    {
    ...
    public Iterator<E> descendingIterator()
    {
        ...
        System.arraycopy(queue, 0, sorted, 0, sorted.length);
        Arrays.sort(sorted);
        return new PriorityDeque.ArrayReverseIterator<>(sorted);
    }
