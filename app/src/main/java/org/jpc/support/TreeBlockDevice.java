...
{    
    ...
    */
     ...
     */
    private TreeBlockDevice(File root, boolean buffer) throws IOException
    {
	...
	public abstract void read(long sectorNumber, byte[] buffer) throws IOException;
        ...
        byte[] getDirectoryEntryComponent()
        {
	...
	public long getStartCluster() 
        ...
        void setSizeClusters(long length)
        {
        ...
        public void write(long sectorNumber, byte[] buffer)
        {
            ...
            for (int i = 0; i < 16; i++) {
                ...
                if (((buffer[32 * i] & 0xFF) == 0xE5) && (followFatChainLink(newStartCluster) == 0)) {
                    ...
                    if ((name.equals(".")) || (name.equals("build/intermediates/exploded-aar/com.android.support/support-v4/21.0.3"))) //skip current and parent directory entries
                        continue;
